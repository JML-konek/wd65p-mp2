...
import { faPlane, faXmark, faBars } from '@fortawesome/free-solid-svg-icons';
...
function Navbar() {
  ...
  return (
    <div className="flex justify-between items-center h-24 mx-auto max-w-[1240px] px-5">
      ...
      <div
        className={
          !nav
            ? 'fixed left-0 top-0 w-[50%] h-full border-r border-r-emerald-300 ease-in-out duration-500 cursor-pointer md:hidden'
            : 'fixed left-[-100%]'
        }
      >
        <ul className="pt-24">
