...
function Eguls() {
  ...
  return (
    <div className="absolute top-0 left-0 z-10 w-full ">
      <div className="items-center py-4 bg-transparent justify-evenly md:flex md:px-10 px-7">
        ...
        <ul
          className={`absolute pb-12  bg-white  lg:bg-transparent md:bg-transparent md:flex h md:items-center md:pb-0 
